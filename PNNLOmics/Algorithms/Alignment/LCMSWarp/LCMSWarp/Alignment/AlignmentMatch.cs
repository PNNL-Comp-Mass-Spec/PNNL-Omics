...
{
    class AlignmentMatch : IComparable<AlignmentMatch>
    {
        ...
        public int CompareTo(AlignmentMatch compareFeature)
        {
            if (compareFeature == null)
            {
                return 1;
            }
            else if (this.m_sectionStart != compareFeature.m_sectionStart)
            {
                return this.m_sectionStart.CompareTo(compareFeature.m_sectionStart);
            }
            else
            {
                return this.m_sectionStart2.CompareTo(compareFeature.m_sectionStart2);
            }
        }
