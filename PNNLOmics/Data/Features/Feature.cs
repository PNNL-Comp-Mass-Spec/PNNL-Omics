...
//            Net                        = 0;
//            NetAligned                 = 0;
//            ScanLC                     = CONST_DEFAULT_SCAN_VALUE;
//            ScanLCAligned              = CONST_DEFAULT_SCAN_VALUE;
//            IsSuspicious                 = false;
...
//                return false;
//            }
//            if (!IsDaltonCorrected.Equals(other.IsDaltonCorrected))
//            {
//                return false;
//            }
...
//                return false;
//            }
//            if (!ElutionTime.Equals(other.ElutionTime))
//            {
//                return false;
//            }
...
//                return false;
//            }
//            if (!MassMonoisotopicAligned.Equals(other.MassMonoisotopicAligned))
//            {
//                return false;
//            }
...
//                return false;
//            }
//            if (!MZCorrected.Equals(other.MZCorrected))
//            {
//                return false;
//            }
...
//                return false;
//            }
//            if (!NetAligned.Equals(other.NetAligned))
//            {
//                return false;
//            }
//            if (!ScanLC.Equals(other.ScanLC))
//            {
//                return false;
//            }
//            if (!ScanLCAligned.Equals(other.ScanLCAligned))
//            {
//                return false;
//            }
//            if (!IsSuspicious.Equals(other.IsSuspicious))
//            {
//                return false;
//            }
//            return true;
