...
namespace PNNLOmics.Data.Constants.Libraries
{
    ...
    public class CrossRingLibrary : MatterLibrary<Compound, CrossRingName>
    {
        ...
        public override void LoadLibrary()
        {
            ...
            var crfHex_02_A2 = new Compound();//102.0316906 Fragment
            ...
            var crfHex_02_X1 = new Compound();//42.0105612 Aldehyde
            ...
            var crfHex_03_A2 = new Compound();//72.0211259 Aldehyde
            ...
            var crfHex_03_X1 = new Compound();//72.0211259 Aldehyde
            ...
            var crfHex_24_A2 = new Compound();//42.0105612 Fragment
            ...
            var crfHex_24_X1 = new Compound();//102.0316906 Aldehyde
            ...
            var crfHexNAc_02_A2 = new Compound();//102.031721493 Fragment
            ...
            var crfHexNAc_02_X1 = new Compound();//83.013331758 Aldehyde
            ...
            var crfHexNAc_03_A2 = new Compound();// Fragment
            ...
            var crfHexNAc_03_X1 = new Compound();// Aldehyde
            ...
            var crfHexNAc_24_A2 = new Compound();//42.01059293 Fragment
            ...
            var crfHexNAc_24_X1 = new Compound();//143.0582706 Aldehyde
            ...
            var crfNeu5Ac_02_X1 = new Compound();//70.0054793084 Aldehyde
            ...
            var crfNeu5Ac_03_X1 = new Compound();// 100.01604399481499 Aldehyde
            ...
            var crfNeu5Ac_24_X1 = new Compound();//190.0477380536 Aldehyde
            ...
            var crfNeu5Ac_25_X1 = new Compound();//143.0582706 Aldehyde
