...
namespace PNNLOmics.Data.Constants.Libraries
{
    ...
    public class AminoAcidLibrary : MatterLibrary<Compound, AminoAcidName>
    {
        ...
        public override void LoadLibrary()
        {
            ...
            var phenylalanine = new Compound();
