...
namespace PNNLOmics.UnitTests.DataTests.Features
{
    ...
    public class UMCClusterLightTests
    {
                                                        ...
                                                        ClusterCentroidRepresentation representation)
        {
            ...
            Assert.AreEqual(cluster.MassMonoisotopic,   umc.MassMonoisotopic);
